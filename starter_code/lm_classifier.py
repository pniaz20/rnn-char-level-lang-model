...
def _parse_args():
    ...
    parser.add_argument('--train_cons', type=str, default='assignment3/starter_code/data/train-consonant-examples.txt', help='path to train consonant examples')
    parser.add_argument('--train_vowel', type=str, default='assignment3/starter_code/data/train-vowel-examples.txt', help='path to train vowel examples')
    parser.add_argument('--dev_cons', type=str, default='assignment3/starter_code/data/dev-consonant-examples.txt', help='path to dev consonant examples')
    parser.add_argument('--dev_vowel', type=str, default='assignment3/starter_code/data/dev-vowel-examples.txt', help='path to dev vowel examples')
    parser.add_argument('--output_bundle_path', type=str, default='assignment3/starter_code/data/classifier-output.json', help='path to write the results json to (you should not need to modify)')
...
def read_examples(file):
    ...
    for line in open(file):
        ...
        # print(line[:-1])
    print("%i lines read in %s"%(len(all_lines), file))
    return all_lines
...
if __name__ == '__main__':
    ...
    if system_to_run == "RNN":
        ...
        raise Exception("Pass in either FREQUENCY or RNN to run the appropriate system")
