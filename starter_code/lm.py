...
def _parse_args():
    ...
    parser.add_argument('--train_path', type=str, default='assignment3/starter_code/data/text8-100k.txt', help='path to train set (you should not need to modify)')
    parser.add_argument('--dev_path', type=str, default='assignment3/starter_code/data/text8-dev.txt', help='path to dev set (you should not need to modify)')
    parser.add_argument('--output_bundle_path', type=str, default='assignment3/starter_code/output.json', help='path to write the results json to (you should not need to modify)')
...
def read_text(file):
    ...
    for line in open(file):
        all_text += line
    print("%i chars read in %s" % (len(all_text), file))
    return all_text
...
if __name__ == '__main__':
    ...
    if args.model == "RNN":
        ...
        raise Exception("Pass in either UNIFORM or RNN to run the appropriate system")
